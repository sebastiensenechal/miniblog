...
class CommentManager extends Manager
{
  ...
  public function postComment($post_id, $author, $comment)
  {
    ...
    $affectedLines = $comments->execute(array($post_id, $author, $comment)); // L'ID du commentaire et la date sont généré automatiquement
  ...
  public function updateComment($id_comment, $post_id, $author, $comment)
    {
      ...
      $comments->bindParam('post_id', $post_id, \PDO::PARAM_INT);
